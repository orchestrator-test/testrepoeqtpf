...
## Running testrepoeqtpf in Quarkus dev mode
...
```
(testrepoeqtpf should be included in the returned array)

Run the following to create an instance of the testrepoeqtpf workflow:

```shell script
curl -XPOST -H "Content-Type: application/json" http://localhost:8080/testrepoeqtpf -d@input.json
```
